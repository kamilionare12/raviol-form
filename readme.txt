=== Raviol Form ===
Contributors: Kamilionare07111975
Version: 12.3
...
= Settingspage =
You can personalize your form via the settingspage. This page can be found via Settings > Raviol Form.
...
Via Settings > Raviol Form you can activate the listing of form submissions in your dashboard.
...
You can avoid this via Settings > Raviol Form.
...
More [translations](https://translate.wordpress.org/projects/wp-plugins/raviol-form) are very welcome!
...
You can change this via Settings > Raviol Form or by using an attribute.
...
* Install another contact form plugin to determine whether it's caused by Raviol Form or not
...
== Screenshots ==
1. Raviol Form (GeneratePress theme).
2. Raviol Form (GeneratePress theme).
3. Raviol Form widget (GeneratePress theme).
4. Raviol Form widget (dashboard).
5. Raviol Form settingspage (dashboard).
6. Raviol Form settingspage (dashboard).
7. Raviol Form settingspage (dashboard).
8. Raviol Form submissions (dashboard).